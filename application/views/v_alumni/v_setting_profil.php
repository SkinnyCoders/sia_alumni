                          ...
                          <form action="" method="post" role="form" enctype="multipart/form-data">
                              <div class="card-body">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="email" class="form-control" placeholder="Email Peserta" value="<?php if(!empty($data_alumni)){
                                    echo $data_alumni['email'];
                                  } ?>">
                                ...
                                <img class="mt-2 mb-2 img-preview" src="<?=base_url('assets/img/user/'.$data_alumni['foto'])?>" id="output">
                              </div>
