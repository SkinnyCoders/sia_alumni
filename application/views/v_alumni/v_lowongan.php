         ...
         <div class="row">
             ...
             <div class="info-box bg-info">
              ...
              <div class="info-box-content">
                  <div class="row">
                      <div class="col-sm-8">
                        <span class="info-box-text">Berikut daftar Lowongan Kerja bulan ini</span>
                        <span class="info-box-number"><?=count($lowongans)?> Lowongan</span>
                      </div>
                      <div class="col-sm-4">
       ...
       <?php foreach($lowongans as $l) : ?>
          ...
          <div class="col-md-3">
            ...
            <div class="card card-widget" style="padding: 2px;">
              ...
              <img style="width: 100%; height: 200px; border-top-left-radius:3px; border-top-right-radius:3px;" src="<?=base_url()?>assets/uploads/file_berita/<?=$l['thumbnail']?>" alt="">
                <!-- <h3 class="widget-user-username">Alexander Pierce</h3>
                <h5 class="widget-user-desc">Founder & CEO</h5> -->
                <div class="row">
                  <div class="col-sm-12" >
                    <div class="description" style="padding: 7px;">
                      <h5 class="text-header mt-2 text-bold"><?=ucwords($l['posisi_pekerjaan'])?></h5>
                      <h6 class="text-dark mt-2 "><?=ucwords($l['perusahaan'])?>- <span class="text-muted"><?=ucwords($l['penempatan'])?></span></h6>
                      <!-- <span class="description-text mb-2">SALES</span> -->
                      <a href="<?=base_url('alumni/lowongan/detail/'.$l['slug'])?>" class="btn btn-info btn-block mt-3">Lihat Detail</a>
                    </div>
                    <!-- /.description-block -->
                  </div>
                </div>
