...
class Pengguna extends CI_controller
{
    ...
    public function update($id)
    {
        ...
        $this->form_validation->set_rules(
            'email',
            'Email',
            'required|valid_email|trim|callback_CekEmailUpdate['.$email.']',
            ['required' => '{field} tidak boleh kosong', 'valid_email' => 'Maaf, {field} tidak valid', 'CekEmailUpdate' => 'Maaf, {field} sudah digunakan!']
        );
